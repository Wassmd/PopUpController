//
//  Copyright © 2020 SwissRE. All rights reserved.
//

import UIKit

extension UIView {
    @discardableResult func centerHorizontally(to layoutElement: LayoutElement,
                                               withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
        return centerXAnchor.constraint(equalTo: layoutElement.centerXAnchor,
                                        constant: offset).activate()
    }

    @discardableResult func centerVertically(to layoutElement: LayoutElement,
                                             withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
        return centerYAnchor.constraint(equalTo: layoutElement.centerYAnchor, constant: offset).activate()
    }

    @discardableResult func pinEdges(to layoutElement: LayoutElement,
                                     withOffset offset: CGFloat = 0) -> [NSLayoutConstraint] {
        setConstraintTranslationToFalse()
        return [
    ...
    @discardableResult func pinTrailingEdge(to layoutElement: LayoutElement,
                                            withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
    ...
    @discardableResult func pinLeadingEdge(to layoutElement: LayoutElement,
                                           withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
        return leadingAnchor.constraint(equalTo: layoutElement.leadingAnchor, constant: offset).activate()
    }

    @discardableResult func pinTrailingEdgeToLeading(of layoutElement: LayoutElement,
                                                     withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
        return trailingAnchor.constraint(equalTo: layoutElement.leadingAnchor, constant: offset).activate()
    }

    @discardableResult func pinTopEdgeToBottom(of layoutElement: LayoutElement,
                                               withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
        return topAnchor.constraint(equalTo: layoutElement.bottomAnchor, constant: offset).activate()
    }

    @discardableResult func pinBottomEdge(lessThanOrEqualTo layoutElement: LayoutElement,
                                          withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        setConstraintTranslationToFalse()
        return bottomAnchor.constraint(lessThanOrEqualTo: layoutElement.bottomAnchor, constant: offset).activate()
    }

    @discardableResult func pinTopAndBottomEdge(to layoutElement: LayoutElement,
                                                withOffset offset: CGFloat = 0) -> [NSLayoutConstraint] {
        setConstraintTranslationToFalse()
        return [
            pinTopEdge(to: layoutElement, withOffset: offset),
